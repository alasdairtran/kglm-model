        ...
        for epoch in epochs:
            ...
            while i < total_length - 2:
                if shuffle:
                    ...
                    sequence_length = min(
                        sequence_length, total_length - 1 - i)
                else:
                    bptt = self._split_size
                    sequence_length = min(
                        self._split_size, total_length - 1 - i)
                if i == 0:
